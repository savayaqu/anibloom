...
(2, 'Кружка Леви', 'Данная кружка из аниме и манги \"Атака титанов\"', '260.99', 50, 'tshirt.jpg', 2, NULL, NULL),
(3, 'Макима', 'Дакимакура макимы с пышными формами.\r\nРазмером 190x60x20', '3619.00', 5, '', 3, NULL, NULL),
...
(9, 'Подушка-дакимакура \"Рем и Рам\" 2', 'Подушка-дакимакура \"Рем и Рам\" 2 с принтом из популярного тайтла Re:Zero - Starting Life in Another World. Доступные размеры: 150x50 см. Сменная наволочка сшитая из плотного атласа легко снимается благодаря «скрытой» молнии в ее нижней части. Набивка состоит из гипоаллергенного и эластичного синтепуха хлопкового каркаса. Двусторонняя печать методом сублимации обеспечивает высокую четкость, цветоустойчивость и стойкость принта на 90 циклов стирок.', '3650.00', 10, NULL, 3, NULL, NULL),
(10, 'Подушка-дакимакура \"Рем и Рам\" 2', 'Подушка-дакимакура \"Рем и Рам\" 2 с принтом из популярного тайтла Re:Zero - Starting Life in Another World. Доступные размеры: 150x50 см. Сменная наволочка сшитая из плотного атласа легко снимается благодаря «скрытой» молнии в ее нижней части. Набивка состоит из гипоаллергенного и эластичного синтепуха хлопкового каркаса. Двусторонняя печать методом сублимации обеспечивает высокую четкость, цветоустойчивость и стойкость принта на 90 циклов стирок.', '3650.00', 10, NULL, 3, NULL, NULL),
(11, 'Подушка-дакимакура \"Мэгумин\"', 'Подушка-дакимакура \"Мэгумин\" с принтом из популярного тайтла Kono Subarashii Sekai ni Shukufuku wo!. Доступные размеры: 150x50 см. Сменная наволочка сшитая из плотного атласа легко снимается благодаря «скрытой» молнии в ее нижней части. Набивка состоит из гипоаллергенного и эластичного синтепуха хлопкового каркаса. Двусторонняя печать методом сублимации обеспечивает высокую четкость, цветоустойчивость и стойкость принта на 90 циклов стирок.', '3650.00', 10, NULL, 3, NULL, NULL),
(12, 'Подушка-дакимакура \"Ху Тао\"', 'Подушка-дакимакура \"Ху Тао\" с принтом из популярного тайтла Genshin Impact. Доступные размеры: 150x50 см. Сменная наволочка сшитая из плотного атласа легко снимается благодаря «скрытой» молнии в ее нижней части. Набивка состоит из гипоаллергенного и эластичного синтепуха хлопкового каркаса. Двусторонняя печать методом сублимации обеспечивает высокую четкость, цветоустойчивость и стойкость принта на 90 циклов стирок.', '3650.00', 10, NULL, 3, NULL, NULL),
(13, 'Подушка-дакимакура \"Сёгун Райдэн\"', 'Подушка-дакимакура \"Сёгун Райдэн\" с принтом из популярного тайтла Genshin Impact. Доступные размеры: 150x50 см. Сменная наволочка сшитая из плотного атласа легко снимается благодаря «скрытой» молнии в ее нижней части. Набивка состоит из гипоаллергенного и эластичного синтепуха хлопкового каркаса. Двусторонняя печать методом сублимации обеспечивает высокую четкость, цветоустойчивость и стойкость принта на 90 циклов стирок.', '3650.00', 10, NULL, 3, NULL, NULL),
(14, 'Подушка-дакимакура \"Марин Китагава\"', 'Подушка-дакимакура \"Марин Китагава\" с принтом из популярного тайтла Sono Bisque Doll wa Koi wo Suru. Доступные размеры: 150x50 см. Сменная наволочка сшитая из плотного атласа легко снимается благодаря «скрытой» молнии в ее нижней части. Набивка состоит из гипоаллергенного и эластичного синтепуха хлопкового каркаса. Двусторонняя печать методом сублимации обеспечивает высокую четкость, цветоустойчивость и стойкость принта на 90 циклов стирок.', '3650.00', 10, NULL, 3, NULL, NULL),
(15, 'Кружка \"Крылья свободы\"', 'Кружка \"Крылья свободы\", оформление в стиле популярной манги и аниме Attack on Titan. Товар выполнен из керамики в белом цвете, а аниме-рисунок обладает устойчивостью к высоким температурам, благодаря чему вы сможете наслаждаться горячими напитками без опасения его испортить.', '590.00', 10, NULL, 2, NULL, NULL),
(16, 'Кружка \"Сайтама\"', 'Белая керамическая аниме-кружка со стойким аниме-рисунком.\r\nАниме-изображение не боится воды и высоких температур.', '590.00', 10, NULL, 2, NULL, NULL),
(17, 'Кружка \"One Piece\"', 'Белая керамическая аниме-кружка со стойким аниме-рисунком.\r\nАниме-изображение не боится воды и высоких температур.', '590.00', 10, NULL, 2, NULL, NULL),
(18, 'Кружка \"K-ON!\" 9', 'Белая керамическая аниме-кружка со стойким аниме-рисунком.\r\nАниме-изображение не боится воды и высоких температур.', '590.00', 10, NULL, 2, NULL, NULL),
(19, 'Кружка \"Ковбой Бибоп\"', 'Белая керамическая аниме-кружка со стойким аниме-рисунком.\r\nАниме-изображение не боится воды и высоких температур.', '590.00', 10, NULL, 2, NULL, NULL),
(20, 'Кружка \"Нориаки Какёин\"', 'Белая керамическая аниме-кружка со стойким аниме-рисунком.\r\nАниме-изображение не боится воды и высоких температур.', '590.00', 10, NULL, 2, NULL, NULL),
(21, 'Большой значок \"Сузуя Джузо\"', NULL, '150.00', 10, NULL, 4, NULL, NULL),
(22, 'Большой значок \"Атака титанов\"', NULL, '150.00', 10, NULL, 4, NULL, NULL),
(23, 'Большой значок \"Темный дворецкий. Пентаграмма\"', NULL, '150.00', 10, NULL, 4, NULL, NULL),
(24, 'Большой значок \"Канеки Кен\"', NULL, '150.00', 10, NULL, 4, NULL, NULL),
(25, 'Большой значок \"Двуличная сестренка Умару\"', NULL, '150.00', 10, NULL, 4, NULL, NULL),
(26, 'Большой значок \"Autism\"', NULL, '150.00', 10, NULL, 4, NULL, NULL),
(27, 'Большой значок \"Нориаки Какёин\"', NULL, '150.00', 10, NULL, 4, NULL, NULL),
(28, 'Большой значок \"Рем\"', NULL, '150.00', 10, NULL, 4, NULL, NULL);
...
(1, 'Лёха', 'НЕГР', 'Бяка', 'lexapro', 'lexapro123', '1990-05-15', 'john@example.com', 1234567890, '$2y$10$GjeYdptsoMmFOGEN5o87NeiOBxdFGjGiwfym0QLNZSA2Nx8SGcrBK', 1, NULL, '2024-02-27'),
(2, 'Алиса', 'Смрад', NULL, 'alice_smith', 'password456', '1995-09-20', 'alice@example.com', 9876543210, NULL, 1, NULL, '2024-02-26'),
(3, 'Боб', 'Бутов', NULL, 'bob_johnson', 'password789', '1988-03-10', 'bob@example.com', 5554443333, NULL, 1, NULL, '2024-02-26'),
(4, 'Василий', 'Уляхин', 'Алексеевич', 'devil', 'devil123', '2024-04-01', 'devil@mail.ru', 3453535, '$2y$10$VuPC4MaO8rFytDaiSWQX4.Id2hk.1ZoziWVJLO/0A/8eIxuHPRBxi', 1, '2024-02-26', '2024-02-26'),
(6, 'savayaqu', 'savayaqu', 'savayaqu', 'savayaqu', 'savayaqu', '2001-01-01', 'savayaqu@mail.ru', 88005553535, '666', 2, '2024-02-26', '2024-02-26');
